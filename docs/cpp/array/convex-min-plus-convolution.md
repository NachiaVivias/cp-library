...
[nachia/array/convex-min-plus-convolution.hpp](https://github.com/NachiaVivias/cp-library/blob/main/Cpp/Include/nachia/array/convex-min-plus-convolution.hpp)
...
* $1 \leq |A| \leq 10^8$
* $1 \leq |B| \leq 10^8$
* $A[i] + A[i] \geq A[i-1] + A[i+1]$ ($1 \leq i \leq |A|-1$)
