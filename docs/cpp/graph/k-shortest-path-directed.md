...
[nachia/graph/k-shortest-path-directed.hpp](https://github.com/NachiaVivias/cp-library/blob/main/Cpp/Include/nachia/graph/k-shortest-path-directed.hpp)

## 主な機能

辺に非負の重みがついた有向グラフ上で、 $s$-$t$ 間の単純パスを短い順に求める。
